...
describe('LgPaginationComponent', () => {
  ...
  describe('#pageChanged', () => {
    ...
    it('should reset pagination state when total items become zero', () => {
      fixture.componentRef.setInput('currentPage', 2);
      fixture.detectChanges();
      pageChangedSpy.mockReset();
      ...
      expect(component.label).toBe('Showing 0-0 of 0 results');
    });

    it('should not emit redundantly when already in empty reset state', () => {
      fixture.componentRef.setInput('totalItems', 0);
      fixture.detectChanges();
