...
Error messages must be clear, concise, and tell the user how to fix the problem. Follow these L&G microcopy standards:
  ...
  - **Be neutral and supportive** – use a factual, calm tone. Do not blame the user, apologize, or use filler words like "Please" or "Sorry."
...
**Do**
  ...
  - **Do** ensure visual clarity – always use the error icon alongside red text to support users with color vision deficiencies.
...
## Refrences
   ...
   • **Inclusive Design Principles** – <a href="https://vispero.com/resources/inclusive-design-principle-provide-a-comparable-experience/" target="_blank">Provide a comparable experience</a> (for color-blind users).
